    ...
    <main className="mx-auto max-w-7xl px-6 py-10">
      <div className="space-y-6 rounded-3xl border border-slate-200 bg-white p-10 shadow-sm">
        <div>
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-900">Bharat Electronics</h1>
        </div>
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-4">
            <p className="text-lg leading-8 text-slate-600">Bharat Electronics provides quality electrical and electronics products including wires, switches, bulbs, coolers, fans, pipes, and accessories at competitive prices.</p>
          ...
          <div className="rounded-3xl bg-slate-950 p-8 text-white">
            ...
            <h2 className="mt-3 text-3xl font-semibold">Aman Saini</h2>
